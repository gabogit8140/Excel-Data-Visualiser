...
const Icon: React.FC<{ name: string; className?: string }> = ({ name, className }) => {
    const icons: { [key: string]: React.ReactElement } = {
        ...
        save: <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 3.75V16.5a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 16.5V3.75m13.5 0h-13.5m13.5 0a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 3.75m13.5 0v1.5c0 .621-.504 1.125-1.125 1.125H4.125A1.125 1.125 0 013 5.25V3.75" />,
        ...
        project: <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5-13.5h16.5M3.75 6a2.25 2.25 0 00-2.25 2.25v1.5A2.25 2.25 0 003.75 12h16.5a2.25 2.25 0 002.25-2.25v-1.5A2.25 2.25 0 0020.25 6H3.75z" />,
